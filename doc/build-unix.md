...
Note
---------------------
Always use absolute paths to configure and compile securypto and the dependencies,
...
This will build securypto-qt as well if the dependencies are met.
...
If you want to build securypto-qt, make sure that the required packages for Qt development
...
Once these are installed, they will be found by configure and a securypto-qt executable will be
built by default.
...
Notes
-----
The release is built with GCC and then "strip securyptod" to strip the debug
...
# Pick some path to install BDB to, here we create a directory within the securypto directory
...
* _Non-executable Stack_: If the stack is executable then trivial stack based buffer overflow exploits are possible if
    vulnerable buffers are found. By default, securypto should be built with a non-executable stack
