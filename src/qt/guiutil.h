...
/** Utility functions used by the Securypto Qt UI.
 */
namespace GUIUtil
{
...
// Render Securypto addresses in monospace font
...
// Parse "securypto:" URI into recipient object, return true on successful parsing
