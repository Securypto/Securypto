...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Securypto Core"),
     ...
     * override -datadir in the securypto.conf file in the default data directory
     * (to be consistent with securyptod behavior)
     */
    if (dataDir != getDefaultDataDirectory())
