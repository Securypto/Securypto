...
#ifndef Securypto_ZSCUTRACKER_H
#define Securypto_ZSCUTRACKER_H
...
public:
    ...
    ~CzSCUTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzSCUWallet* zSCUWallet = NULL);
