...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Securypto Core securypto-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  securypto-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded securypto transaction") + "\n" +
                               "  securypto-tx [options] -create [commands]   " + _("Create hex-encoded securypto transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded securypto transaction
